...
const dutyData = {
    1: { day: "วันจันทร์", names: ["จูเนียร์", "ศุพัสษร นิลดวง", "ขันติ", "พงศกร", "จิราพัชร", "พร้อม", "คริสตัล"] },
    2: { day: "วันอังคาร", names: ["นิว", "ยิ้ม", "ขวัญข้าว", "ออก้า", "กิ้บ", "แฮคกี้"] },
    3: { day: "วันพุธ", names: ["นายเจริญวัฒน์ สีบัว", "นายกวีวัธน์ บัวทอง", "นายชยพรรธน์", "อั่งเปา", "แมมมอส", "ต้า"] },
    4: { day: "วันพฤหัสบดี", names: ["ญาณิศา ชุมนุม", "ปิยะรัตน์ ภูมี", "กิ๊บ" , "ฐิติวัฒน์ บุญศรี"] },
