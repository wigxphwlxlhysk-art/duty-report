...
const dutyData = {
    1: { day: "วันจันทร์", names: ["นายวิศรุต แขมคำ ()", "นางสาวศุพัสษร นิลดวง ()", "นายจิรสิน วิทยารักษ์ ()", "นายพงศกร ไชยรักษ์ ()", "นางสาวจิราพัชร ผิวอ่อน ()", "นายวรินทร อัมพร ()", "นายพัฒนศักดิ์ กองทุ่งมน ()"] },
    2: { day: "วันอังคาร", names: ["นางสาวนภัสวรรณ จงกลศรี ()", "นางสาวอพินญา เตียวระสิงห์ ()", "นางสาวสุพิชชา บุญอ่วม ()", "นางสาวธวัลรัตน์ เป็นมงคล ()", "นางสาวปาลิตา บุญด้วง ()", "นางสาวปริยาภัทร วงศ์จีน ()"] },
    3: { day: "วันพุธ", names: ["นายเจริญวัฒน์ สีบัว ()", "นายกวีวัธน์ บัวทอง ()", "นายชยพรรธน์ สุราราษฎร์ ()", "นายธนาธิป วิริยะกูล ()", "นายภัทรกร เทียมใสย ()", "นายนพรุจ จันทร์ทรง ()"] },
    4: { day: "วันพฤหัสบดี", names: ["นางสาวญาณิศา ชุมนุม ()", "นางสาวปิยะรัตน์ ภูมี ()", "นางสาวกาญจนา สิตวัน ()" , "นายฐิติวัฒน์ บุญศรี ()"] },
    5: { day: "วันศุกร์", names: ["นางสาววรัญญา อุทัยศรี ()", "นางสาวปริณดา นาคประโคน ()", "นางสาวอัญรินทร์ วงษาชัย ()", "นางสาวจิรัชยา ดาพันธ์ ()", "นางสาวภัทรวดี ผ่องศรี ()", "นางสาวประภาวรรณ สุตาวงศ์ ()", "นายบวรพจน์ ยืนสุข ()"] }
};
