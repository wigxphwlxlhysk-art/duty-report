...
const dutyData = {
    1: { day: "วันจันทร์", names: ["นายวิศรุต แขมคำ (จูเนียร์)", "นางสาวศุพัสษร นิลดวง (เก้า)", "นายจิรสิน วิทยารักษ์ (ขันติ)", "นายพงศกร ไชยรักษ์ (อังเปา)", "นางสาวจิราพัชร ผิวอ่อน (เห็ดหอม)", "นายวรินทร อัมพร (พร้อม)", "นายพัฒนศักดิ์ กองทุ่งมน (คริสตัล)"] },
    ...
    3: { day: "วันพุธ", names: ["นายเจริญวัฒน์ สีบัว (ยอด)", "นายกวีวัธน์ บัวทอง (ไบเบิ้ล)", "นายชยพรรธน์ สุราราษฎร์ (เจา)", "นายธนาธิป วิริยะกูล (ต๊ะ)", "นายภัทรกร เทียมใสย (แมมมอธ)", "นายนพรุจ จันทร์ทรง (กีต้าร์)"] },
    4: { day: "วันพฤหัสบดี", names: ["นางสาวญาณิศา ชุมนุม ()", "นางสาวปิยะรัตน์ ภูมี (น้ำใส)", "นางสาวกาญจนา สิตวัน (กิ๊บ)" , "นายฐิติวัฒน์ บุญศรี (ออม)"] },
